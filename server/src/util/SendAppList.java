...
public class SendAppList extends DefaultHandler {
    ...
    public SendAppList(remoteserver.RemoteServer rs) {
        this.rs = rs;
    }
     ...
     */
    public static void startSending(remoteserver.RemoteServer rs) throws IOException, SAXException, ParserConfigurationException {
